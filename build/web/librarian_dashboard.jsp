...
<body>
    ...
    <div class="dashboard-container" role="main" aria-label="Dashboard navigation cards">
        ...
        <div class="card" data-icon="return" tabindex="0" role="button" aria-label="Return Books" onclick="location.href='TransactionServlet?action=viewAll'">
            <h3>Return Books</h3>
            <p>🔄</p>
        </div>
        ...
        <div class="card" data-icon="reports" tabindex="0" role="button" aria-label="View Reports" onclick="location.href='ReportsServlet'">
            <h3>Reports</h3>
            <p>📊</p>
        </div>
